...
public class ConfirmHotelRegistrationCommandImpl implements Command {
    private static final String ID = "id";
    private static final String HOTELS = "hotels";
    private static final String HOTEL_CONFIRM_REGISTRATION_ERROR = "confirmRegistrationError";
    ...
    public CommandResult execute(HttpServletRequest req) throws CommandException {
        ...
        try {
            ...
            if (optionalHotel.isPresent()) {
                optionalHotel.get().setRegistered(true);
                updateHotel = hotelService.update(optionalHotel.get());
            } else {
                req.setAttribute(HOTEL_CONFIRM_REGISTRATION_ERROR, ERROR_FLAG);
            }
