...
public class GetHotelManagerAllRoomsPageCommandImpl implements Command {
    ...
    public CommandResult execute(HttpServletRequest req) throws CommandException {
        ...
        try {
            ...
            if (hotel.isPresent() && hotel.get().isRegistered()) {
                ...
                commandResult.setPage(PageManager.getPageURI(PageMappingConstant.HOTEL_MANAGER_ALL_ROOMS_PAGE.getKey()));
            } else {
