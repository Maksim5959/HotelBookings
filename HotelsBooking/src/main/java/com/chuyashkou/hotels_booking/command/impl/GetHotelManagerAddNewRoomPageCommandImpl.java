...
public class GetHotelManagerAddNewRoomPageCommandImpl implements Command {
    ...
    public CommandResult execute(HttpServletRequest req) throws CommandException {
        ...
        try {
            ...
            if (hotel.isPresent() && hotel.get().isRegistered()) {
                ...
                commandResult.setPage(PageManager.getPageURI(PageMappingConstant.HOTEL_MANAGER_ADD_NEW_ROOM_PAGE.getKey()));
            } else {
